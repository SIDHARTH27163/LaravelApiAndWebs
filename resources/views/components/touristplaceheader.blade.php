 ...
 <nav id="header" class="w-full  drop-shadow-lg px-4  font-roboto fixed top-0 z-50">
    <div class="w-full flex flex-wrap items-center justify-between  mt-0 py-2.5 l lg:px-2 md:px-2 px-0 ">
    ...
    <a href="/" class="flex flex-row  drop-shadow-lg  hover:rounded-full transform transition hover:scale-110 duration-500 ease-in-out">
      ...
      <button id="nav-toggle" class="flex items-center p-1 text-yellow-600  hover:text-slate-950  transform transition hover:scale-110 duration-300 ease-in-out">
      ...
      <div class="w-full font-Robotomedium flex-grow lg:flex lg:items-center lg:w-auto hidden mt-1 lg:mt-0  lg:bg-transparent  p-2 lg:p-0 z-20 " id="nav-content">
        ...
        <li class="mr-0">
            <a id="navitem" class="toggleColour hover:bg-slate-900 hover:text-white text-yellow-500 inline-block text-2xl font-MerriweatherRegular hover:shadow-lg hover:rounded-xl   no-underline  transform transition hover:scale-105 duration-500 ease-in-out py-2 px-4 font-bold" href="/touristplaces">Home</a>
          </li>
          <li class="mr-0">
            <a id="navitem1" class="toggleColour2 hover:bg-slate-900 hover:text-white text-yellow-500 inline-block text-2xl font-MerriweatherRegular hover:shadow-lg hover:rounded-xl  no-underline  transform transition hover:scale-105 duration-500 ease-in-out py-2 px-4 font-bold" href="/touristplaces/popularplaces">Popular Places</a>
          </li>
